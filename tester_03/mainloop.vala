...
namespace Netsukuku
{
    ...
    class Tasklet01 : Object, ITaskletSpawnable
    {
        public void * func()
        {
            ...
            print("tester03: TIME_01\n");

            // first_identity_data: my id TESTER_SERVER03_ID01 is in network_id TESTER_SERVER03_NETWORK01.
    ...
    class Tasklet04 : Object, ITaskletSpawnable
    {
        public void * func()
        {
            ...
            second_identity_data = find_or_create_local_identity(new NodeID(TESTER_SERVER03_ID02));
    ...
    class Tasklet06 : Object, ITaskletSpawnable
    {
        public void * func()
        {
            ...
            third_identity_data = find_or_create_local_identity(new NodeID(TESTER_SERVER03_ID03));
