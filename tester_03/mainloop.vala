...
namespace Netsukuku
{
    ...
    class OldTasklet : Object, ITaskletSpawnable
    {
        public void * func()
        {
            ...
            print("tester03: after 6 seconds.\n");
            ...
            // second_identity_data nodeid 399143400 should be in about 3 more seconds bootstrapped in network_id TESTER_SERVER02_NETWORK01.
