...
// then, after 1 second SERVER01_ID02 joins network SERVER02_NETWORK01.
const int TESTER_TIME_02 = 3000;

const int TESTER_SERVER01_ID02 = 1267178494;

// then, after 3 seconds hooking module on server02 report signal 'same_network' for identity-arc with server01;
